...
namespace Vgc\MainBundle\Listener;
...
class LoginListener {
    ...
    public function redirigeUtilisateurVersPageAccueil(FilterResponseEvent $oResponseEvent) {
        ...
        if ($oUtilisateurConnecte->estMembre() || $oUtilisateurConnecte->estAdministrateur()) {
            $oResponse = new RedirectResponse($this->oRouter->generate('accueil'));
        }
